  ...
  >
    <Link
      className={clsx(
        ...
        {
          "dark:text-gray-500 dark:hover:text-gray-300": theme === "dark", 
          "dark:text-gray-300": theme === "dark" && activeSection === link.name,
          // Dark mode hover and default text color
          "text-gray-950": theme === "light" && activeSection === link.name, // Active section text color in light mode
        }
      )}
      href={link.hash}
      onClick={() => {
